...
class saveSkin {
    ...
    public $acceptedSkinSize = [64 * 32 * 4, 64 * 64 * 4, 128 * 128 * 4];
    public $skin_widght_map = [64 * 32 * 4 => 64, 64 * 64 * 4 => 64, 128 * 128 * 4 => 128];

    public $skin_height_map = [64 * 32 * 4 => 32, 64 * 64 * 4 => 64, 128 * 128 * 4 => 128];
